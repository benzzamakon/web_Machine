...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            ...
            $sqlSearch = "SELECT * FROM product WHERE ProductName LIKE '%".$search."%' AND ProductCategory = 'แก้ม' ORDER BY 	ProductName ASC ";
            ...
            <div class="row">
              ...
              {
                $productId = $resultSearch["ProductID"];
              ?>
              <a  href="outputproduct.php?ProductID=<?php echo $resultSearch["ProductID"];?>">
                <div class="col-sm-2">
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h5><?php echo $resultSearch["ProductName"]; ?></h5>
                      </div>
                        <div class="panel-body">
                            <img  src="Imgproduct/<?php echo $resultSearch['ProductPicture'];?>"width="115px"height="115px">
                            </div>
                        </div>
                    </div>
                  </a>
