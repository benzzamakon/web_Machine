...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            ...
            $sqlSearch = "SELECT * FROM product WHERE ProductName LIKE '%".$search."%' ORDER BY 	ProductName ASC ";
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        ...
                        <div class="panel-body">
                            <img  src="Imgproduct/<?php echo $resultSearch['ProductPicture'];?>" width="185px"height="185px">
                            </div>
                        </div>
                    </div>
                  </a>
