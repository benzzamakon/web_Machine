...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
              <form action="Orderapp.php" method="post">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h4><input type="hidden" name="ProductName" value="<?php echo $result['ProductName'];?>"><?php echo $result['ProductName'];?></h4>
                      </div>
                        <div class="panel-body">
                              ...
                              <div class="col-sm-9">
                                <p><?php echo $result['productColor'];?></p>
